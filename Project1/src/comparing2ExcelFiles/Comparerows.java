...
public class Comparerows {
	...
	static boolean comparegivenrows()	{
        try {
            // get input excel files
            FileInputStream excellFile1 = new FileInputStream(new File(Main_method.Excel1Path));
            FileInputStream excellFile2 = new FileInputStream(new File(Main_method.Excel2Path));
		  ...
		  // TODO Auto-generated method stub
		   int firstRow1 = sheet1.getFirstRowNum();
		         ...
		         for(int i=firstRow1; i <= lastRow1; i++) {
		        	 ...
		        	 System.out.println("\n Row indices for data in Excel_1 and Excel_2 were: " + Get_cellvalues1.a +", " + Get_cellvalues2.a1);
		             System.out.println("\n Comparing both rows");		      
		             XSSFRow row1 = sheet1.getRow(Get_cellvalues1.a);
		             XSSFRow row2 = sheet2.getRow(Get_cellvalues2.a1);
		             if(!compareTwoRows(row1, row2)) {
		                 equalSheets = false;
		                 System.err.println(" Rows are not Equal");
		                 break;
		             } else {
